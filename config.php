...
define('SP_CSS_CLIENT',		plugins_url('view/client/cool-poll.css', __FILE__));
define('SP_CSS_ADMIN',		plugins_url('view/admin/admin-cool-poll.css', __FILE__));
define('SP_JS_CLIENT',		plugins_url('script/CoolPoll.js', __FILE__));
define('SP_JS_ADMIN',		plugins_url('script/CoolPoll-admin.js', __FILE__));