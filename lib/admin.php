...
class CoolPollAdmin extends CoolPoll{
...
//		$this->pollDB = new CoolPollDB();
		
		add_action('admin_init',	array($this, 'enqueueFiles'));
		add_action('admin_menu',	array($this, 'addCoolPollMenu'));
	...
	public function enqueueFiles() {		
		...
		wp_enqueue_script('jCoolPollAdmin',	SP_JS_ADMIN,	false,	SP_VERSION);
	 ...
	 */
	public function addCoolPollMenu() {
		
		$capability = 'manage_options';
		$parentPage = 'sp-poll';
		
		add_menu_page('cool poll', 'Polls', $capability, $parentPage, array($this, 'getAdminPageMain'),'', 6);
